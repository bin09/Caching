...
namespace Caching.WebCache
{
    public sealed class CacheManage : AbstractCache
    {
        #region 变量
        /// <summary>
        /// 内存缓存
        ...
        public override void Add(string key, object obj, params string[] files)
        {
        ...
        public override void Add(string key, object obj, DateTime dateTime)
        {
